...
class GraphicalInterface:
    def __init__(self):
        ...
        self.theoretical = self.ax.plot(
            THEORETICAL_TIME, THEORETICAL_THICKNESS, color="b", ls=":", label="Theoretical"
        )[0]
    ...
    def create_window(self):
        ...
        canvas_layout = sg.Frame(
            layout=[[canvas_frame1, canvas_frame2]], title="", expand_y=True, expand_x=True, border_width=2
        )
        ...
        input_layout = [
            ...
            [sg.Button("Save plots", key="SAVE", font=button_font, disabled=True, s=(36, 1))],
            [
                sg.Button(
                    "Power ON",
                    key="START-ELECTRICITY",
                    s=(17, 1),
                    font=button_font,
                    expand_x=True,
                    button_color="green",
                ...
                sg.Button(
                    "Power OFF",
                    key="EMERGENCY_STOP_ELECTRICITY",
                    s=(17, 1),
                    font=button_font,
                    button_color="red",
                    disabled=True,
        ...
        self.window = sg.Window(
            ...
            icon=path_to_title_icon,
            titlebar_icon=path_to_title_icon,
        )
